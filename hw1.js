...
const Product = class Product {
    constructor(input) {
        ...
        this.name = myArray[0];
        this.price = parseFloat(myArray[1]);
        this.availability = myArray[2];
    }
    /**
     * *****************
     * ***** TODO ******
    ...
    static halfOff = (products) => {
        ...
        for (const product of products) {
                var arr = new Product(`${product.name},${product.price *.50},${product.availability}`);
    ...
    for (const product of products) {
        ...
        if(product.availability=="Out of Stock"){
                console.log(`Product: ${product.name}, Cost: $${price}, Availability: No`);
               }
               else{
                console.log(`Product: ${product.name}, Cost: $${price}, Availability: Yes`);
               }
      }
    }
 };
